...
class gClassScreenPage extends StatefulWidget {
  const gClassScreenPage({super.key});

  @override
  State<gClassScreenPage> createState() => _gClassScreenPage();
}

class _gClassScreenPage extends State<gClassScreenPage> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "Shop Number: 69, Jalandhar, Punjab",
                          style: TextStyle(
                              fontSize: 14,
