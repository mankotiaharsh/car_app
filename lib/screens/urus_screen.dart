...
class lamboScreenPage extends StatefulWidget {
  const lamboScreenPage({super.key});

  @override
  State<lamboScreenPage> createState() => _lamboScreenPage();
}

class _lamboScreenPage extends State<lamboScreenPage> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "Shop Number: 89, Jalandhar, Punjab",
                          style: TextStyle(
                              fontSize: 14,
